    ...
    return (
      <ImageBackground source={require('../../assets/back_drawer.png')} imageStyle={{ resizeMode: 'cover' }} style={styles.wrapperStyle}>
        <View style={styles.containerStyle}>
          { this.renderSection(this.state.sections[0], styles.textStyle, styles.sectionStyle, () => {console.log("Planned trips")}) }
          { this.renderSection(this.state.sections[1], styles.textStyle, styles.sectionStyle, () => {console.log("Trip History")}) }
          { this.renderSection(this.state.sections[2], styles.textStyle, styles.sectionStyle, () => {console.log("Offers")}) }
          { this.renderSection(this.state.sections[3], styles.textStyle, styles.sectionStyle, 
                              () => {console.log("Preferences"); Actions.settings()}) }
