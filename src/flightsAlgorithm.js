...
const
    ...
    getTickets = async (budget, dateTo, dateFrom, destination, origin) => {
        const
            ticketsTo = [],
            ticketsBack = [],
            url = 'https://desktopapps.ryanair.com/v4/en-gb/availability?ADT=1&CHD=0&DateIn=2019-05-22&DateOut=2019-05-16&Destination=CGN&FlexDaysIn=0&FlexDaysOut=0&INF=0&IncludeConnectingFlights=false&Origin=SXF&RoundTrip=true&TEEN=0&ToUs=AGREED&exists=false',
        ;
        let currency = '';
